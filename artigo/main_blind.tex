...
%%
%% [Author identifiers removed for double-blind peer review]
%%
...
\shortauthors{[Authors removed for review]}
...
%% ----------------------------------------------------------------
%% Authors — identifiers removed for double-blind review
%% ----------------------------------------------------------------
\author[1]{Author 1}
\cormark[1]
\fnmark[1]
...
\affiliation[1]{%
  organization={[Institution 1 removed for review]},
  country={Brazil}
}
...
\affiliation[2]{%
  organization={[Institution 2 removed for review]},
  country={Brazil}
}
...
\fntext[1]{[Role and affiliation removed for review]}
\fntext[2]{[Role and affiliation removed for review]}
\fntext[3]{[Role and affiliation removed for review]}
\fntext[4]{[Role and affiliation removed for review]}
\fntext[5]{[Role and affiliation removed for review]}
...
[Author et al., 2026] exemplifies the translational potential of these
...
abstracts were screened independently by two reviewers, with agreement
assessed using Cohen's kappa coefficient ($\kappa = 0.78$). Disagreements
were resolved by a third reviewer or by the corresponding author. Full texts
of potentially eligible records were then retrieved and assessed against the
eligibility criteria. The selection process is documented in the PRISMA-ScR
flowchart (Fig.~\ref{fig:prisma}).
...
Author et al.\ [2026] propose exactly this integration: a prospective
...
The methodological protocol described in [Author et al., 2026] represents a
