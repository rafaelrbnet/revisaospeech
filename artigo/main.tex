...
\fntext[2]{Undergraduate research student, Computer Engineering, USF.}
...
\fntext[5]{Faculty and supervisor, Graduate Program in Health Data Science, USF.}
...
First, despite searching five electronic databases with six complementary
strings, the heterogeneity of indexing practices across platforms means that
some relevant studies published in grey literature, conference proceedings, or
non-indexed journals may not have been captured. The \textit{snowballing}
strategy was applied to partially mitigate this gap.
