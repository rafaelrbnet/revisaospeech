...
%% APC: USD 3,310 -- confirm coverage under the CAPES/Elsevier Read &
%%      Publish Agreement 2026-2028 for this specific journal.
%% Class: elsarticle.cls (numbered/Vancouver-style references)
%% Peer review at AIM is single-anonymized -- see main_blind.tex for
%% the anonymised copy required at submission.
%%
%% NOTE: This file is the English version for AIM submission (branch: en-submission).
%% Portuguese version for internal review is maintained on the main branch.
%%

\documentclass[review,12pt]{elsarticle}

%% NOTE: elsarticle already loads natbib in numbered mode internally;
%% do not \usepackage{natbib} again here (causes an option clash).
...
%% [usf1]: Graduate Program in Health Data Science, USF
%% [usf2]: Computer Engineering, USF (undergraduate research students)
%% ----------------------------------------------------------------
\author[usf1]{Rafael Baena Neto\corref{cor1}\fnref{fn1}}
\ead{rafael.baena@mail.usf.edu.br}

\author[usf2]{Fabrício Evangelista dos Santos\fnref{fn2}}
\ead{fabricio.evangelista@mail.usf.edu.br}

\author[usf2]{Lucas Kenzo Terazzin Ida\fnref{fn3}}
\ead{lucas.ida@mail.usf.edu.br}

\author[usf2]{Murilo Nogueira Minutti\fnref{fn4}}
\ead{murilo.minutti@mail.usf.edu.br}

\author[usf1]{Vicente Idalberto Becerra Sablón\fnref{fn5}}
\ead{vicente.sablon@usf.edu.br}

\cortext[cor1]{Corresponding author.}
\fntext[fn1]{MSc student, Graduate Program in Health Data Science, USF.}
\fntext[fn2]{Undergraduate research student, Computer Engineering, USF.}
\fntext[fn3]{Undergraduate research student, Computer Engineering, USF.}
\fntext[fn4]{Undergraduate research student, Computer Engineering, USF.}
\fntext[fn5]{Faculty and supervisor, Graduate Program in Health Data Science, USF.}

\address[usf1]{Graduate Program in Health Data Science, Universidade
São Francisco (USF), Rua Alexandre Rodrigues Barbosa, 45, Bragança
Paulista, SP, 12916-900, Brazil}
\address[usf2]{Department of Computer Engineering, Universidade São
Francisco (USF), Rua Alexandre Rodrigues Barbosa, 45, Bragança
Paulista, SP, 12916-900, Brazil}
...
and JBI \citep{Peters2020}. Searches were conducted across six electronic
databases (PubMed/MEDLINE, Scopus, Web of Science, EBSCO/CINAHL, Cochrane
Library, and Google Scholar; January 2014--July 2026; English, Spanish, and
Portuguese), using six search strings in PubMed/MEDLINE and five in the
remaining databases, and supplemented by manual \textit{snowballing}. Of
5,621 records identified across the six databases (3,189 after
deduplication) and 7 additional
...
Analytics} has recently been proposed \citep{BaenaNeto2026}. That protocol
...
The literature search was conducted across six electronic databases:
PubMed/MEDLINE (primary database), Scopus, Web of Science, EBSCO/CINAHL,
Cochrane Library, and Google Scholar. Searches were performed independently
by three researchers, each applying multiple strategies covering the five
...
review. The remaining five databases (Scopus, Web of Science, EBSCO/CINAHL,
Cochrane Library, and Google Scholar) were searched using the five thematic
strings only, with query syntax adapted to each platform's field codes and
operators while preserving the conceptual scope of each string; Cochrane
Library's focus on controlled trials and intervention reviews meant only
the first thematic string was applicable there (see Supplementary File S1
for the complete adapted strings per database). In an earlier search
...
Records retrieved from all six databases were exported and deduplicated
...
%% ou, na ausência de decisões humanas por registro, reportar sensibilidade do LLM
%% contra os 24 artigos finalmente incluídos (ver validar_sensibilidade.py)
...
Searches across the six electronic databases (PubMed/MEDLINE, Scopus, Web
of Science, EBSCO/CINAHL, Cochrane Library, and Google Scholar) retrieved
5,621~records (Web of Science: 1,719; Scopus: 1,580; PubMed/MEDLINE: 1,059;
EBSCO/CINAHL: 586; Cochrane Library: 399; Google Scholar: 278). After removing
...
published for orthopedic rehabilitation in SUS \citep{BaenaNeto2026}. The
...
free full-text filter -- a 7.2-fold increase in identified records relative
to the earlier single-database search -- the final inclusion count remained
at 17 database-derived studies. Inspection of the excluded records shows
that this is largely attributable to the composition of the expanded
corpus rather than to an overly restrictive screening process: the
majority of the additional records retrieved were returned by the two most
general thematic strings (clinical NLP and symptom extraction; named
entity recognition and clinical information extraction), which
predominantly indexed studies applying NLP to disease detection and
diagnostic support -- outside this review's scope -- and were
consequently excluded under EC1 (no NLP/ASR of clinical
\emph{interactions}) or EC3 (exclusive focus on voice-based diagnosis).
This pattern suggests that the operationalisation of clinical interaction
as a speech-derived measurable variable, the specific gap this review
maps, remains a narrow and underexplored niche even within a
substantially larger and broader-scoped corpus.
...
(\url{https://doi.org/10.5281/zenodo.20821064});
...
\textbf{Rafael Baena Neto:} Conceptualization, Methodology, Data curation,
Formal analysis, Writing -- original draft.
\textbf{Fabrício Evangelista dos Santos:} Investigation, Data curation,
Methodology, Software, Writing -- review \& editing.
\textbf{Lucas Kenzo Terazzin Ida:} Investigation, Data curation, Formal
analysis, Writing -- review \& editing.
\textbf{Murilo Nogueira Minutti:} Investigation, Data curation, Formal
analysis, Visualization, Writing -- review \& editing.
\textbf{Vicente Idalberto Becerra Sablón:} Supervision, Conceptualization,
